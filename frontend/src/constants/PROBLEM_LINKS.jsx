export const BEST_TIME_TO_BUY_AND_SELL_STOCK_LINK =
	'https://leetcode.com/problems/best-time-to-buy-and-sell-stock/';
export const BINARY_SEARCH_LINK = 'https://leetcode.com/problems/binary-search';
export const ARITHMETIC_PROGRESSION_LINK =
	'https://leetcode.com/problems/can-make-arithmetic-progression-from-sequence/';
export const LONGEST_CONSECUTIVE_SEQUENCE_LINK =
