import {
	...
	LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_APPROACH,
	DIVIDE_TWO_INTEGERS_APPROACH,
	MERGE_STRINGS_ALTERNATELY_APPROACH,
	GREATEST_COMMON_DIVISOR_OF_STRINGS_APPROACH,
} from './APPROACHES';
import {
	...
	LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_SNIPPET,
	DIVIDE_TWO_INTEGERS_SNIPPET,
	MERGE_STRINGS_ALTERNATELY_SNIPPET,
	GREATEST_COMMON_DIVISOR_OF_STRINGS_SNIPPET,
} from './CODE_SNIPPETS';
...
import {
	...
	LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_DESCRIPTION,
	DIVIDE_TWO_INTEGERS_DESCRIPTION,
	MERGE_STRINGS_ALTERNATELY_DESCRIPTION,
	GREATEST_COMMON_DIVISOR_OF_STRINGS_DESCRIPTION,
...
import {
	...
	LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_LINK,
	DIVIDE_TWO_INTEGERS_LINK,
	MERGE_STRINGS_ALTERNATELY_LINK,
	GREATEST_COMMON_DIVISOR_OF_STRINGS_LINK,
} from './PROBLEM_LINKS';
...
export const EASY_PROBLEMS = [
	...
	},
	{
		...
		difficulty: EASY,
		description: GREATEST_COMMON_DIVISOR_OF_STRINGS_DESCRIPTION,
		approach: GREATEST_COMMON_DIVISOR_OF_STRINGS_APPROACH,
		codeSnippet: GREATEST_COMMON_DIVISOR_OF_STRINGS_SNIPPET,
		link: GREATEST_COMMON_DIVISOR_OF_STRINGS_LINK,
		number: 1071
	},
	{
		title: 'Merge Strings Alternately',
		difficulty: EASY,
		description: MERGE_STRINGS_ALTERNATELY_DESCRIPTION,
		approach: MERGE_STRINGS_ALTERNATELY_APPROACH,
		codeSnippet: MERGE_STRINGS_ALTERNATELY_SNIPPET,
		link: MERGE_STRINGS_ALTERNATELY_LINK,
		number: 1768
	}
];
...
export const MEDIUM_PROBLEMS = [
	...
	},
	{
		...
		difficulty: MEDIUM,
		description: LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_DESCRIPTION,
		approach: LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_APPROACH,
		codeSnippet: LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_SNIPPET,
		link: LETTER_COMBINATIONS_OF_A_PHONE_NUMBER_LINK,
		number: 17
	},
	{
		title: 'Divide Two Integers',
		difficulty: MEDIUM,
		description: DIVIDE_TWO_INTEGERS_DESCRIPTION,
		approach: DIVIDE_TWO_INTEGERS_APPROACH,
		codeSnippet: DIVIDE_TWO_INTEGERS_SNIPPET,
		link: DIVIDE_TWO_INTEGERS_LINK,
		number: 29
	}
];
